...
<main>
    ...
    <div class="container">
        ...
        <div>
            <img src="https://cdn.tgdd.vn/Files/2015/11/25/746505/shiftwear-classic-1.gif" alt="">
            <h3>ShiftWear Classic</h3>
            <p>
                ShiftWear Classic thuộc mẫu giày thể thao Badass cho phép tùy chỉnh hiển thị thiết kế theo cách riêng của bạn, thông qua điện thoại hoặc máy tính bảng trong vài giây.
            </p>
            <a href="#">Chi tiết <i class="fas fa-chevron-right"></i></a>
        </div>
        <div>
            <img src="https://cdn.tgdd.vn/Files/2015/11/25/746505/starry-night-an-gogh-on-sneakers-by-shiftwear.gif" alt="" />
            <h3>ShiftWear Classic</h3>
            <p>
                ShiftWear Classic thuộc mẫu giày thể thao Badass cho phép tùy chỉnh hiển thị thiết kế theo cách riêng của bạn, thông qua điện thoại hoặc máy tính bảng trong vài giây.
            </p>
...
.showcase {
  width: 100%;
  height: 800px;
  background: url('https://cms-static.asics.com/media-libraries/42282/file.original.gif') no-repeat center center/cover;
  display: flex;
...
.xbox {
  width: 100%;
  height: 350px;
  background: url('https://www.baohotoandien.com/blog/wp-content/uploads/2019/09/banner-giay-bao-ho-blog.gif') no-repeat center center/cover;
  margin-bottom: 20px;
}
